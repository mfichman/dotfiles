...
syn keyword c3Keyword return for break else if import  match var intf const struct union static typeof pub func mut match field reflect end do elseif or and xor try raise then from in
